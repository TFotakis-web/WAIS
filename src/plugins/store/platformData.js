...
export const platformData = {
	...
	getters: {
		...
		permissionOptions: () => [
			...
			{ text: $i18n.global.t('components.navigation.sidenav.contractors.suppliers'), value: 'SupplierContractors' },
			{ text: $i18n.global.t('components.navigation.sidenav.contractors.externalContractors'), value: 'ContractorsExternalContractors' },
