			...
			<div class="mdb-list-view">
				...
				<table>
					<tbody v-for="(event, index) in events" :key="index">
						<tr
							v-if="
								event.start < new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate() + 7) &&
									event.end >= new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate())
							"
						...
						>
							...
							<th
								v-if="event.start.toLocaleTimeString() === '00:00:00' && event.end.toLocaleTimeString() === '23:59:59'"
